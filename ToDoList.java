...
public class ToDoList {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        do {
            ...
            System.out.println("\n                                                                  \u001b[38;5;15mYou still have \u001b[38;5;11m" + (maxTasks - tasks.size()) + "\u001b[38;5;15m free spaces on the list!\u001b[0m");
            ...
            System.out.println("\u001b[38;5;15m                                                                  10 - \u001b[38;5;11mUpdate task time\u001b[0m");
            System.out.println("\u001b[38;5;15m                                                                  11 - \u001b[38;5;11m🌟Upgrade🌟 \u001b[38;5;15mToDoList Plan\u001b[0m");
            ...
            switch (userChoice) {
                ...
                case 11:
                    ...
                    break;
                case 0:
                    System.out.println("\n\u001b[38;5;9m                                                                        Closing ToDoList program... Byeeee 😘\u001b[0m");
                    break;
                default:
                    System.out.println("\n\u001b[38;5;9m                                                                        Invalid option!\u001b[0m");
                    break;
            }
    ...
    public static void createTask() {
        ...
        if (tasks.size() < maxTasks) {
            ...
            System.out.println("\n\u001b[38;5;10m                                                                        The task '\u001b[38;5;15m" + "📜 " + userNewTask +
                    "  🏷️ " + userNewInfo + "\u001b[38;5;10m' was created!\u001b[0m");
        } else {
            System.out.println("\n\n\u001b[38;5;9m                                                                        The list is full! You don't have more space.\u001b[0m");
        }
    }
        ...
        if (tasks.size() != 0) {
            ...
            if (userChoiceOfTaskToMarkAsCompleted >= 0 && userChoiceOfTaskToMarkAsCompleted < tasks.size()) {
                if (tasks.get(userChoiceOfTaskToMarkAsCompleted).done) {
                    System.out.println("\n\u001b[38;5;9m                                                                        That task is already marked as completed!\u001b[0m");
                } else {
                    tasks.get(userChoiceOfTaskToMarkAsCompleted).done = true;
                    System.out.println("\n\u001b[38;5;10m                                                                        Task successfuly marked as completed!\u001b[0m");
                }
            } else {
                System.out.println("\n\u001b[38;5;9m                                                                        Invalid task option!\u001b[0m");
            }
        } else {
            System.out.println("\n\u001b[38;5;9m                                                                        You don't have tasks!\u001b[0m");
        }
    }
    ...
    public static void unmarkTaskAsCompleted() {
        ...
        if (existsCompletedTasks > 0) {
            ...
            System.out.println("\n\u001b[38;5;9m                                                                        You don't have completed tasks!\u001b[0m");
        }
    }
    ...
    public static void editTask() {
        ...
        if (tasks.size() != 0) {
            ...
            if (userChoiceOfTaskToEdit >= 0 && userChoiceOfTaskToEdit < tasks.size()) {
                ...
                System.out.println("\n\u001b[38;5;10m                                                                        Info '\u001b[38;5;15m" + tasks.get(userChoiceOfTaskToEdit).info + "\u001b[38;5;10m' edited!");
            ...
            System.out.println("\n\u001b[38;5;9m                                                                        You don't have tasks to edit!\u001b[0m");
        }
    }
    ...
    public static void deleteTask() {
        ...
        if (tasks.size() > 0) {
            ...
            if (userChoiceOfTaskToDelete >= 0 && userChoiceOfTaskToDelete < tasks.size()) {
                System.out.println("\u001b[38;5;10m                                                                        The task '\u001b[38;5;15m" + tasks.get(userChoiceOfTaskToDelete).description + "\u001b[38;5;10m' was successfully deleted!\u001b[0m");
                garbage.add(tasks.get(userChoiceOfTaskToDelete));
                tasks.remove(userChoiceOfTaskToDelete);
            } else {
                System.out.println("\u001b[38;5;9m                                                                        Invalid task option!\u001b[0m");
            }
        } else {
            System.out.println("\u001b[38;5;9m                                                                        You don't have tasks to delete!\u001b[0m");
        }
    }
    ...
    public static void updateTime() {
        if (premiumPlan) {
            ...
            if (tasks.size() > 0) {
                ...
                System.out.println("\u001b[38;5;9m                                                                        You don't have tasks to update!\u001b[0m");
            }
